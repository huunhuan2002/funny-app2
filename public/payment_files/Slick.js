(function (n) {
  ...
  t.prototype.cleanUpEvents = function () {
      ...
      t.options.arrows === !0 &&
          ...
          t.options.accessibility === !0 && (t.$prevArrow && t.$prevArrow.off("keydown.slick", t.keyHandler), t.$nextArrow && t.$nextArrow.off("keydown.slick", t.keyHandler)));
  ...
  t.prototype.getDotCount = function () {
      ...
      if (n.options.infinite === !0)
          ...
          else while (i < n.slideCount) ++t, (i = r + n.options.slidesToScroll), (r += n.options.slidesToScroll <= n.options.slidesToShow ? n.options.slidesToScroll : n.options.slidesToShow);
      ...
      return (
          ...
          t.options.infinite === !0
              ? (t.slideCount > t.options.slidesToShow &&
                    ...
                    (e = -1),
                    t.options.vertical === !0 && t.options.centerMode === !0 && (t.options.slidesToShow === 2 ? (e = -1.5) : t.options.slidesToShow === 1 && (e = -2)),
  ...
  t.prototype.lazyLoad = function () {
      ...
      if (
          (t.options.centerMode === !0
              ? t.options.infinite === !0
                  ? ((i = t.currentSlide + (t.options.slidesToShow / 2 + 1)), (r = i + t.options.slidesToShow + 2))
                  : ((i = Math.max(0, t.currentSlide - (t.options.slidesToShow / 2 + 1))), (r = 2 + (t.options.slidesToShow / 2 + 1) + t.currentSlide))
              : ((i = t.options.infinite ? t.options.slidesToShow + t.currentSlide : t.currentSlide), (r = Math.ceil(i + t.options.slidesToShow)), t.options.fade === !0 && (i > 0 && i--, r <= t.slideCount && r++)),
      ...
      t.slideCount <= t.options.slidesToShow
          ...
          ? ((f = t.$slider.find(".slick-cloned").slice(0, t.options.slidesToShow)), e(f))
          : t.currentSlide === 0 && ((f = t.$slider.find(".slick-cloned").slice(t.options.slidesToShow * -1)), e(f));
  };
  ...
  t.prototype.postSlide = function (t) {
      ...
      i.unslicked ||
          ...
          i.options.accessibility === !0 && (i.initADA(), i.options.focusOnChange && ((r = n(i.$slides.get(i.currentSlide))), r.attr("tabindex", 0).focus())));
  };
  ...
  t.prototype.swipeMove = function (n) {
      ...
      if (
          ...
          (e = t.swipeDirection()),
          n.originalEvent !== undefined && t.touchObject.swipeLength > 4 && ((t.swiping = !0), n.preventDefault()),
...
!(function (n) {
  n.fn.slickAnimation = function () {
      function i(n, t, i, r, u) {
          u = "undefined" != typeof u ? u : !1;
          1 == t.opacity ? (n.addClass(i), n.addClass(r)) : (n.removeClass(i), n.removeClass(r));
          u && n.css(t);
      }
      function o(n, t) {
          return n ? 1e3 * n + 1e3 : t ? 1e3 * t : n || t ? 1e3 * n + 1e3 * t : 1e3;
      }
      function t(n, t, i) {
          var u = ["animation-" + t, "-webkit-animation-" + t, "-moz-animation-" + t, "-o-animation-" + t, "-ms-animation-" + t],
              r = {};
      ...
      var u = n(this),
          h = u.find(".slick-list .slick-track > div"),
          s = u.find('[data-slick-index="0"]'),
          r = "animated",
          f = { opacity: "1" },
          e = { opacity: "0" };
      return (
          h.each(function () {
              var h = n(this);
              h.find("[data-animation-in]").each(function () {
                  var c = n(this);
                  c.css(e);
                  var v = c.attr("data-animation-in"),
                      y = c.attr("data-animation-out"),
                      l = c.attr("data-delay-in"),
                      a = c.attr("data-duration-in"),
                      p = c.attr("data-delay-out"),
                      w = c.attr("data-duration-out");
                  y
                      ? (s.length > 0 &&
                            h.hasClass("slick-current") &&
                            (i(c, f, v, r, !0),
                            l && t(c, "delay", l),
                            a && t(c, "duration", a),
                            setTimeout(function () {
                      ...
                      : (s.length > 0 && h.hasClass("slick-current") && (i(c, f, v, r, !0), l && t(c, "delay", l), a && t(c, "duration", a)),
                        u.on("afterChange", function () {
                            h.hasClass("slick-current") && (i(c, f, v, r, !0), l && t(c, "delay", l), a && t(c, "duration", a));
                        }),
                        u.on("beforeChange", function () {
                            i(c, e, v, r, !0);
                        }));
  ...
  function () {
              ...
              (n.prototype.createEvent = function (n, t, i, r) {
                  ...
                  return (
                      ...
                      null != document.createEvent
                          ? ((u = document.createEvent("CustomEvent")), u.initCustomEvent(n, t, i, r))
      ...
      this.WOW = (function () {
          ...
          return (
              (u.prototype.defaults = { boxClass: "wow", animateClass: "animated", offset: 0, mobile: !0, live: !0, callback: null, scrollContainer: null }),
              (u.prototype.init = function () {
                  var n;
                  return (
                      (this.element = window.document.documentElement), "interactive" === (n = document.readyState) || "complete" === n ? this.start() : this.util().addEvent(document, "DOMContentLoaded", this.start), (this.finished = [])
                  );
              }),
              (u.prototype.start = function () {
                  ...
                  if (
                      ...
                      else for (r = this.boxes, i = 0, u = r.length; u > i; i++) (t = r[i]), this.applyStyle(t, !0);
                  return (
                      this.disabled() ||
              ...
              (u.prototype.customStyle = function (n, t, i, r, u) {
                  return (
                      ...
                      i && this.vendorSet(n.style, { animationDuration: i }),
                      r && this.vendorSet(n.style, { animationDelay: r }),
                      u && this.vendorSet(n.style, { animationIterationCount: u }),
                      this.vendorSet(n.style, { animationName: t ? "none" : this.cachedAnimationName(n) }),
                      n
                  );
              }),
